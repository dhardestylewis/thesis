...
\begin{enumerate}
    ...
    \item \textbf{Methods:} We implement the two core paradigms scheduled for \textbf{Weeks 6--7} of the seminar:
    \begin{itemize}
        ...
        \item \textbf{Bayesian Invariant Prediction (BIP):} A \textit{probabilistic inference} paradigm defining a latent \textbf{feature selection vector} $z \in \{0,1\}^p$; the \textbf{posterior} $p(z|D)$ \textbf{targets the true invariant features} [Wu et al., 2025b, p. 2].
    \end{itemize}
\end{enumerate}
