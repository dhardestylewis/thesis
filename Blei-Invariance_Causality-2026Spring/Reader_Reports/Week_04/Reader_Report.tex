...
\title{\vspace{-2.5em}\textbf{Reader Report: Week 04} \\ \vspace{0.1em} \large Bayesian Invariant Prediction \& Optimization-Based ICP}
...
With roughly four environments and fifty features the invariant set is likely underdetermined, so we pair two methods that trade off differently. \citet{fan2024negdro} cast recovery as minimax,
\[
