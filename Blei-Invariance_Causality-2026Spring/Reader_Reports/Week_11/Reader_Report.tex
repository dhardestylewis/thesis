...
\section*{Next Steps}
Formalize the change-point detection within the GP framework (likely via a product kernel combining a stationary base and a change-point indicator \citep{aglietti2021dcbo}). Evaluate whether SAFEOPT \citep{sui2015safeopt} would have achieved a Pareto-superior trajectory (higher yield, lower protest rate) than the historical sequence, and quantify the regret gap attributable to the unmodeled structural shift.
