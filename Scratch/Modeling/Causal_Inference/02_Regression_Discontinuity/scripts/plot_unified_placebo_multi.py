...
OUT_PLOT = rf"{OUT_DIR}\rd_unified_multi_target_placebos.png"
...
def main():
    ...
    # Load additional target columns from case_master
    ...
    print("Plotting Multi-Target Unified Grid...")
    fig, axes = plt.subplots(1, 3, figsize=(18, 6), dpi=200)
    
    plot_target_panel(axes[0], res_app, "Probability of Final Council Approval", "#3498DB", y_label=True)
    plot_target_panel(axes[1], res_with, "Probability of Developer Withdrawal", "#F39C12")
    plot_target_panel(axes[2], res_den, "Probability of City Denial", "#E74C3C")
    
    plt.suptitle("Multi-Target Treatment Effect Stability Across All Thresholds", fontsize=16, weight="bold", y=0.98)
