...
# CONTINUOUS OUTCOME: Actual Height in Feet Gained/Lost
Y = cs['Delta_Approved_Height'].values
...
for i, surf in enumerate(surfaces):
    ...
    step = dict(
        ...
        args=[{'visible': [True] + [False] * len(surfaces)},
              {'title': f'Spatial CATE Surface for Petition Dose >= {thresh:.3f} (Continuous Height)'}],
...
if surfaces:
    ...
    fig.update_layout(
        sliders=sliders,
        title=f'Spatial CATE Surface for Petition Dose >= {first_t:.3f} (Continuous Height)',
        scene=dict(
            xaxis_title='Longitude',
            yaxis_title='Latitude',
            zaxis_title='Treatment Effect (Height Feet)',
    ...
    out_path = r'C:\Users\dhl\.gemini\antigravity\brain\1632e32a-ef31-4422-854b-ea7296224fe1\cate_spatial_dose_slider_continuous_unofficial.html'
