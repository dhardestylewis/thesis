...
output_file = r"c:\Users\dhl\data\Thesis\thesis\Data\zoning_platting_commission_index.csv"
records = []
comm_id = 54  # 54 = Zoning and Platting Commission
...
for year in reversed(years):
    ...
    while page <= 10:  # Hard limit
        if year == 2026:
            url = f"https://www.austintexas.gov/boards-commissions/meetings/{comm_id}_1" if page == 1 else f"https://www.austintexas.gov/boards-commissions/meetings/2026_{comm_id}_{page}"
        else:
            url = f"https://www.austintexas.gov/boards-commissions/meetings/{year}_{comm_id}_{page}"
        ...
        next_page_str = f'href="/boards-commissions/meetings/{year}_{comm_id}_{page+1}"'
        next_page_str2 = f'href="/boards-commissions/meetings/{comm_id}_{page+1}"'
