...
node_x = [0.05, 0.35, 0.35, 0.65, 0.95, 0.65, 0.95]
node_y = [0.05, 0.05, 0.60, 0.85, 0.85, 0.05, 0.05]
...
for year in years:
    ...
    dead_app = pct(len(df_y[df_y['Derived_Status'] == 'Dead (At Application)']))
    dead_pc = pct(len(df_y[df_y['Derived_Status'] == 'Dead (At PC)']))
    dead_zap = pct(len(df_y[df_y['Derived_Status'] == 'Dead (At ZAP)']))
    dead_council = pct(len(df_y[df_y['Derived_Status'] == 'Dead (At Council)']))

    ongoing_app = pct(len(df_y[df_y['Derived_Status'] == 'Ongoing (At Application)']))
    ongoing_pc = pct(len(df_y[df_y['Derived_Status'] == 'Ongoing (At PC)']))
    ongoing_zap = pct(len(df_y[df_y['Derived_Status'] == 'Ongoing (At ZAP)']))
    ongoing_council = pct(len(df_y[df_y['Derived_Status'] == 'Ongoing (At Council)']))
    ...
    source = [0, 0, 0, 0, 1, 1, 1, 2, 2, 2, 5, 5, 5]
    target = [3, 4, 1, 2, 3, 4, 5, 3, 4, 5, 6, 3, 4]
    value  = [
