...
df['Friction_Staff_Height'] = df['Staff_Effective_Height'] - df['Requested_max_height_ft']
df['Friction_Council_Height'] = df['Effective_Approved_Height'] - df['Staff_Effective_Height']

print("Successfully calculated Temporal Friction Deltas.")
print(df[['case_number', 'Requested_Zoning', 'Staff_Recommendation', 'Final_Zoning', 'Friction_Staff_Height', 'Friction_Council_Height']].dropna(subset=['Staff_Recommendation']).head(15))
