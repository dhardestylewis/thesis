...
print("[*] Engineering Forward Geographic Timelines with Symmetric Features...")
...
for scale_name, geo_col in geo_scales.items():
    ...
    # 1. Aggregate Features Symmetrically
    agg_feats = df.groupby([geo_col, 'year'])[numeric_cols].mean().reset_index()
    ...
    X_valid = valid[numeric_cols].values
...
print("\n=== Symmetrical Topography GeoAgg Breakdown ===")
print("Tracking percentage error deviation when model specifically aggregates inputs to identical bounding sizes.")
