...
tex_lines = [
    ...
    r'\caption[Temporal Drift (Max-of-Family Dominance)]{\textbf{Max-of-Family architectural dominance.} Maximum absolute PR-AUC generated by either the linear baseline or the non-linear tree ensembles. Cells where the linear model outperforms trees are bolded, illustrating the structural boundary of linear capacity under domain shift.}',
