...
tex_lines = [
    ...
    r'\caption[Temporal Drift (Max-of-Family Dominance)]{\textbf{Max-of-Family architectural dominance.} Maximum absolute PR-AUC generated by either the linear baseline or the non-linear tree ensembles, highlighting the structural boundary of architectural capacity under domain shift.}',
