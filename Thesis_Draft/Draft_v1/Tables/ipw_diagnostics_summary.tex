\begin{table}[H]
\centering
\caption{Stage A IPW Diagnostic Summary (Stabilized and Truncated Weights)}
...
\bottomrule
\multicolumn{4}{l}{\footnotesize Notes: $\hat e_i = \Pr(D=1\mid X_i)$ from the Stage A selection model. ESS computed as $ (\sum_i w_i)^2 / \sum_i w_i^2 $.} \\
