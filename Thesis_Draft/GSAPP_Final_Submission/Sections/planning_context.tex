...
\subsubsection{Suburban Mobilization and Commission Defiance: Balcones Country Club, 2013} \cite{case_c14_2013_0098}
...
\subsubsection{Urban Core Complexity and Applicant Surrender: The Shelley Tract, 2013} \cite{case_c14_2013_0104}
...
Urban core cases like this one never reach a petition vote. The institutional expectation of supermajority requirements at council makes withdrawal the rational response before the case advances. This is why the study's multi-horizon panel captures petition hazard at intermediate stages, not only at final council action: the mechanism's deterrent effect operates well before any formal vote is cast.

\subsubsection{Cultural Preservation and East Austin Opposition: East Cesar Chavez, 2008} \cite{case_c14_2008_0247}
...
Semi-structured interviews were conducted with urban planning professionals and city staff with direct experience in Austin's discretionary zoning system (Columbia University IRB Protocol ACYY0820). The interview sample is purposive and small-$N$; it is used here to establish institutional context, not to test hypotheses or estimate effect sizes.
