...
\cite{case_c14_2013_0104} 

The Shelley Tract in the Judges Hill neighborhood (District 9) involved an attempt to convert a historic single-family structure to limited office use. The case activated simultaneous opposition from the Judges Hill Neighborhood Association, the Downtown Austin Neighborhood Association, and Preservation Austin, a coalition dense enough to make compromise structurally difficult. At the November 2013 hearing, the Commission proposed a conditional overlay capping height and impervious cover at 45\%. That attempt at a negotiated middle ground failed on a 2-5-1 vote. Faced with an irreconcilable coalition, the applicant formally withdrew.
...
To supplement the quantitative modeling, semi-structured interviews were conducted with urban planning professionals and city staff with direct experience navigating Austin's discretionary zoning system (Columbia University IRB Protocol ACYY0820). The interview sample is purposive and small-$N$ ($N=4$), deliberately constructed via snowball sampling to capture diverse institutional vantage points. Participants included a former senior zoning planner, a current principal planner, a displacement prevention specialist, and a leading housing advocate. Interviews were conducted virtually via Zoom, lasting approximately 45--60 minutes, following a standardized guide (see Appendix A). Audio was transcribed and coded thematically using a deductive framework aligned with the study's hypotheses on institutional friction, spatial heterogeneity, and petition deterrence. This qualitative data is used to establish institutional context, ground-truth algorithmic assumptions, and highlight the limits of administrative data, not to test statistical hypotheses. The key findings from these discussions reveal that petition dynamics are highly localized, temporally unstable, and often obscure latent community support, directly shaping the thesis's predictive and causal architecture.
