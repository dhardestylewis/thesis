...
\bottomrule
\end{tabular}
\caption[Zoning Trajectory Deltas by Protest Status]{Zoning Trajectory Deltas by Protest Status. Protested cases show a near-universal rate (97.5\%) of final zoning outcomes diverging from the applicant's initial request, mathematically substantiating the friction hypothesized by NIMBY mobilization.}
