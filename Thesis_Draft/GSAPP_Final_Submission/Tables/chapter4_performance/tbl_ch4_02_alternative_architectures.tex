...
The corresponding metrics are detailed in \autoref{tab:alt_architectures}.

\begin{table}[htbp]
\centering
\caption[Candidate Architectures Evaluated at Filing]{Supporting-Component and Filing-Date Models Evaluated at Filing: Raw vs. Calibrated Candidate Architectures}
