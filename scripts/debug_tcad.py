...
try:
    h = pd.read_csv(r'c:\Users\dhl\data\thesis\thesis\Data\Warehouse_As_Of\H0_Filing_Complete.csv')
    ...
    p = pd.read_csv(r'c:\Users\dhl\data\thesis\thesis\Data\Panel\Output\Property_Year_Panel_Enriched.csv', usecols=['standardized_tcad_id', 'year'], low_memory=False)
