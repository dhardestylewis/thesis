...
def main():
    ...
    dest_stagea = root / "Thesis_Draft/Draft_v1/Tables/stagea_limits.tex"
    ...
    geo_causal_path = root / "Thesis_Draft/Draft_v1/Tables/geographic_causal.tex"
...
\end{table}""", encoding="utf-8")
    ...
    # Stage B
    stage_b_path = root / "Thesis_Draft/Draft_v1/Tables/stage_b.tex"
...
\end{table}""", encoding="utf-8")
    ...
    # Seed summary 
    seed_path = root / "Thesis_Draft/Draft_v1/Tables/seed_summary.tex"
...
\end{table}""", encoding="utf-8")
    ...
    disq_path = root / "Thesis_Draft/Draft_v1/Tables/disqualification_matrix.tex"
...
\end{table}""", encoding="utf-8")
    ...
    # Spuriousness Index
    spur_path = root / "Thesis_Draft/Draft_v1/Tables/spuriousness_index.tex"
