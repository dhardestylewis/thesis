...
ALT_CONTACTS = [
    {
        ...
        "hook": "Given HPNA's unique approach to <b>Neighborhood Conservation Combining Districts</b>, I am writing to request a brief interview to discuss how Hyde Park is navigating between preservation and the city's recent push for density."
    },
    {
        "name": "Bill Bunch",
        ...
        "hook": "I've run into your past testimony on <b>various development projects and environmental ordinances</b> (including the recent West US 290 debate), and I am writing to request a brief interview to discuss the specific patterns of neighborhood and environmental concern you see influencing Council decisions versus those that get ignored."
    },
    {
        "name": "Chris Affinito",
        ...
        "hook": "I've run into your work on <b>various infill communities like The Reyna and Springdale</b>, and I am writing to request a brief interview to discuss the your experience with the permitting of these projects and the specific neighborhood feedback that you find most challenging to address."
    }
]
