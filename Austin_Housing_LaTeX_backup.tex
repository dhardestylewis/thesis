...
The human consequences of this supply shortage were severe. By 2022, the median home price in Austin reached \$542,000, having increased 165\% in just a decade.\cite{abor2022} Median rent for a one-bedroom apartment hit \$1,587, pricing out essential workers, teachers, and even many tech employees.\cite{rentcafe2022} The African American population in East Austin, historically the heart of the city's Black community, fell from 16\% to 7\% between 2000 and 2020 as longtime residents were displaced by gentrification.\cite{tang2016} Homelessness increased by 125\% between 2019 and 2023, with over 5,500 individuals experiencing homelessness on any given night.\cite{echo2023}
...
By 2000, Austin was the only major Texas city where the African American population was declining in absolute numbers, falling from 12\% in 1990 to 10\% in 2000 and continuing to fall to 7.8\% by 2020.\cite{census2020} The Hispanic population, while growing in absolute numbers, saw its share of the city population decline from 35.1\% to 32.5\% over the same period as gentrification displaced longtime residents from historically Latino neighborhoods. These demographic shifts reflected not natural market forces but the deliberate policy choices embedded in Austin's land use regulations.
...
HOME Phase 2's most controversial provision---complete elimination of parking minimums---proved surprisingly uncontroversial when it came to a vote on May 16, 2024. Austin became the largest U.S. city after San José to completely eliminate parking requirements, a change that planning textbooks had long considered politically impossible in car-dependent American cities.\cite{shoup2024}
...
Despite political success, implementing HOME faced immediate practical challenges. The Development Services Department, already struggling with permitting delays, was overwhelmed by the surge in applications. Permit review times, which had improved to 60 days pre-HOME, stretched back to 120 days by mid-2024 as staff struggled to process complex projects under new rules.\cite{cityaustin2024dsd}
...
Austin's Development Services Department (DSD), responsible for reviewing and approving building permits, became an unexpected constraint on housing production. Despite regulatory reforms reducing barriers, administrative capacity limited how quickly projects could move from approval to construction. Permit review times, which had improved to 60 days before HOME, stretched to 120-180 days by mid-2024 as application volume overwhelmed staff capacity.\cite{cityaustin2024dsd}

The numbers illustrated the challenge starkly. Permit applications increased from 15,000 in 2023 to 28,000 in 2024. Staff levels increased only 15\%, from 420 to 480 employees. Each reviewer handled 40\% more cases, leading to burnout and turnover. The city lost 30\% of experienced plan reviewers to private sector jobs, further reducing capacity. New hires required 6-12 months training before reaching full productivity.\cite{dsd2024report}
